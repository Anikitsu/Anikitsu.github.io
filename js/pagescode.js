...
pagesEn[0]='<h1>Aniki-Chen</h1><h3>Write original code, build methodical world.</h3>'+
			...
			'</nav>'+
			'<p>At this time, using IE/Edge to browse this page,<br/>will show the motion and the details of this page correctly<br/>If there are still some problems,<br/>please try refreshing</p>';

pagesEn[1]='<h2>Ad/vantage</h2>'+
			'<div class="article">'+
...
pagesZh[0]='<h1>你好，我是小陈</h1><h3 style="margin-top:0.5em;">无需精彩生活，只求北京工作</h3>'+
			...
			'</nav>'+
			'<p>这回用IE/Edge浏览这个不会看起来怪怪的了<br/>如果还是怪怪的，再刷新一次试试吧</p>';

pagesZh[1]='<h2>一名没什么修养的前端</h2>'+
			'<div class="article">'+
				'<div class="article-container">'+
					'<p class="icon fa-circle"> Javascript，原生的好！</p>'+
